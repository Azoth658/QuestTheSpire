...
public class PoisonMasteryPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public PoisonMasteryPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public void onApplyPower(AbstractPower power, AbstractCreature target, AbstractCreature source) {
        if(power.ID == PoisonPower.POWER_ID){
    ...
    public AbstractPower makeCopy() {
        return new PoisonMasteryPower(owner, source, amount);
    }
}
